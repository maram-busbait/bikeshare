...
def get_filters():
    ...
    while True:
           try:
            city = input("enter which city do want  to analyze is it chicago, new york or washington:").lower()
    ...
    while True:
           ...
           try:
              month = input("enter which months you are interested about it january, february, march, april, may, june:").lower()
              if month in months:
               break
           except:
             print("it is not except")
